...
set_option define {ZETAS_KYBER_ROM_FILE="/users/xcarril/pqcuark_ntt/src/rtl/twiddle_factor_rom/zetas_kyber.hex"}
set_option define {ZETAS_DILITHIUM_ROM_FILE="/users/xcarril/pqcuark_ntt/src/rtl/twiddle_factor_rom/zetas_dilithium.hex"}
