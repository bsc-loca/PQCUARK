...
void print_keccak_state(const uint64_t s[25]) {
    for (int i = 0; i < 25; i++) {
        PRINTF("S[%2d] = 0x%016llx\n", i, (unsigned long long)s[i]);
    }
    PRINTF("\n");
}
