...
void poly_pointwise(poly *c, const poly *a, const poly *b)
{
    ...
    poly_pointwise_pqcuark(c->coeffs, a->coeffs, b->coeffs);
    for (int i = 0; i < 10; ++i) {
    }
...
void poly_pointwise_acc(poly *c, const poly *a, const poly *b)
{
    ...
    poly_pointwise_acc_pqcuark(c->coeffs, a->coeffs, b->coeffs);
