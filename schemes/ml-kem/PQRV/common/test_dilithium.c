...
int main(void)
{
    ...
    printf("****** Dilithium Vector Test *******\n");
    #elif defined(BITMAN)
    printf("****** Dilithium Bit Manipulation Test *******\n");
    #elif defined(VBITMAN)
    printf("****** Dilithium Vector + Bit Manipulation Test *******\n");
    #elif defined(RV32) || defined(RV64)
    printf("****** Dilithium Scalar Optimized Test *******\n");
    #else
    printf("****** Dilithium Reference Test *******\n");
    #endif
    printf("**************************************\n");
